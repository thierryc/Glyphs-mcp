...
This is the tool surface exposed by the server shipped in this repo (FastMCP `version="1.0.11"`).
...
These tools help you generate and apply compensated tuning transforms across two compatible masters.
They are for compensated scaling, not for single-master lighten/darken edits.
