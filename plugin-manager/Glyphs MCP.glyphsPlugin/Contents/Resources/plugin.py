...
def _ensure_user_site_packages_on_path() -> None:
    """Apply the shared installer/runtime dependency path policy."""
    plan = build_runtime_path_plan(_glyphs_user_site_packages(), sys.executable)
