...
| `glyphs-mcp-scripting` | Staged-document and reviewed open-world Python fallback with explicit rollback coverage. |
| `glyphs-mcp-opentype-features` | OpenType features and stylistic-set inspection. |
| `glyphs-mcp-production-audit` | Read-first production readiness across compatibility, spacing, anchors, kerning, and export. |
...
manages the shared agent package: it copies the fourteen canonical directories from
...
package version instead of maintaining fourteen independent version fields, while
