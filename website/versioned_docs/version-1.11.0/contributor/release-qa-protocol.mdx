...
- Install/upgrade both Glyphs targets with the release installer. Confirm
  ...
  and build number agree. Each host resolves version `1.11.0`, the same 11
...
[skill-routing prompt fixture](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/src/glyphs-mcp/tests/fixtures/llm_skill_routing.json)
