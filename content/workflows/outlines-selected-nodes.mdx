...
- `get_selected_nodes`, `get_glyph_paths`, `render_glyph_review_image`, and `review_collinear_handles` are read-only.
...
- Render a visual review image after outline proposals and before any mutation.
