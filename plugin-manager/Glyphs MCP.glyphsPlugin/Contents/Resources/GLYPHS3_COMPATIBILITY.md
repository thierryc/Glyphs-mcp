...
- Review tools: `review_spacing`, `review_kerning_bumper`,
  `review_master_stem_metrics`, and candidate preview/review workflows.
...
- Native Reporter controls and docs: `set_curve_review_overlay`,
  `get_curve_review_overlay_state`, `docs_search`, `docs_get`.
