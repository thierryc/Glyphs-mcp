...
| `glyphs-mcp-opentype-features` | Review and debug native Glyphs 4 feature source, compilation and exported behavior | `Use $glyphs-mcp-opentype-features to review feature source with the lean v2 native workflow.` |
