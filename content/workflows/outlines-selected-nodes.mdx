...
- You want a visual proof image before accepting an outline proposal or mutation.
...
- `get_selected_nodes`, `get_glyph_paths`, `review_curve_quality`, and candidate previews do not edit the font.
...
- Enable the native curve or candidate Reporter after outline proposals and before any mutation.
