...
repository ChatGPT/Codex marketplace plug-in, embedded feedback panel, guarded
...
- Add richer shape, component, grouping, attribute, and compatibility
  diagnostics.
- Add the ChatGPT/Codex marketplace plug-in, synchronize its eight skills from canonical
...
Result: `400` Python tests passed, `1` skipped; `78` macOS installer
