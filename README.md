...
**Safer skill updates and atomic custom-parameter edits.**
...
[Read the full 1.5.2 changelog →](CHANGELOG.md) ·
...
## Command Set (MCP server v1.5.2)
This table describes the tool surface exposed by the MCP server shipped in this repo (FastMCP `version="1.5.2"`).
