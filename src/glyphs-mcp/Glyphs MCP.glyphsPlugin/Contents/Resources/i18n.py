...
STRINGS = {
    ...
    "menu.changes": {
        ...
        "de": "Glyphs MCP-Änderungen…",
        "fr": "Modifications Glyphs MCP…",
        "es": "Cambios de Glyphs MCP…",
    ...
    "changes.retention": {
        "en": "Current Glyphs run · up to 256 recent events; aggregate counts are retained",
        "de": "Aktueller Glyphs-Lauf · bis zu 256 letzte Ereignisse; Gesamtzahlen bleiben erhalten",
        "fr": "Session Glyphs actuelle · jusqu’à 256 événements récents; les totaux sont conservés",
        "es": "Ejecución actual de Glyphs · hasta 256 eventos recientes; se conservan los totales",
        "pt": "Execução atual do Glyphs · até 256 eventos recentes; os totais são mantidos",
        "zh-Hans": "当前 Glyphs 运行期间 · 最多保留 256 个最近事件，合计数据会保留",
    },
    ...
    "changes.omitted": {
        "en": "{count} earlier event(s) omitted",
        "de": "{count} frühere Ereignis(se) ausgelassen",
        "fr": "{count} événement(s) antérieur(s) omis",
        "es": "{count} evento(s) anterior(es) omitido(s)",
        "pt": "{count} evento(s) anterior(es) omitido(s)",
        "zh-Hans": "已省略 {count} 个较早事件",
    },
    "changes.column.time": {"en": "Time", "de": "Zeit", "fr": "Heure", "es": "Hora", "pt": "Hora", "zh-Hans": "时间"},
    "changes.column.outcome": {"en": "Outcome", "de": "Ergebnis", "fr": "Résultat", "es": "Resultado", "pt": "Resultado", "zh-Hans": "结果"},
    "changes.column.action": {"en": "Action", "de": "Aktion", "fr": "Action", "es": "Acción", "pt": "Ação", "zh-Hans": "操作"},
    "changes.column.target": {"en": "Target", "de": "Ziel", "fr": "Cible", "es": "Destino", "pt": "Alvo", "zh-Hans": "目标"},
    "changes.open_target": {"en": "Open Target", "de": "Ziel öffnen", "fr": "Ouvrir la cible", "es": "Abrir destino", "pt": "Abrir alvo", "zh-Hans": "打开目标"},
    "changes.copy_summary": {"en": "Copy Summary", "de": "Zusammenfassung kopieren", "fr": "Copier le résumé", "es": "Copiar resumen", "pt": "Copiar resumo", "zh-Hans": "复制摘要"},
    "changes.reset": {"en": "Reset", "de": "Zurücksetzen", "fr": "Réinitialiser", "es": "Restablecer", "pt": "Redefinir", "zh-Hans": "重置"},
    "changes.unsaved": {"en": "Unsaved document", "de": "Ungesichertes Dokument", "fr": "Document non enregistré", "es": "Documento sin guardar", "pt": "Documento não salvo", "zh-Hans": "未保存文稿"},
    "changes.untitled": {"en": "Untitled font", "de": "Unbenannte Schrift", "fr": "Police sans titre", "es": "Fuente sin título", "pt": "Fonte sem título", "zh-Hans": "未命名字体"},
    "changes.empty": {
        "en": "No document is being tracked. Tracking starts with the first MCP mutation.",
        "de": "Kein Dokument wird verfolgt. Die Erfassung beginnt mit der ersten MCP-Änderung.",
        "fr": "Aucun document n’est suivi. Le suivi commence à la première modification MCP.",
        "es": "No se está siguiendo ningún documento. El seguimiento empieza con el primer cambio MCP.",
        "pt": "Nenhum documento está sendo acompanhado. O acompanhamento começa na primeira alteração MCP.",
        "zh-Hans": "尚未跟踪文稿。跟踪将从第一次 MCP 更改开始。",
    },
    "changes.counts": {
        "en": "Changed {changed}   Succeeded {succeeded}   Failed {failed}   Uncertain {uncertain}   Saves {saved}",
        "de": "Geändert {changed}   Erfolgreich {succeeded}   Fehlgeschlagen {failed}   Unklar {uncertain}   Sicherungen {saved}",
        "fr": "Modifié {changed}   Réussi {succeeded}   Échoué {failed}   Incertain {uncertain}   Enregistrements {saved}",
        "es": "Cambiado {changed}   Correcto {succeeded}   Fallido {failed}   Incierto {uncertain}   Guardados {saved}",
        "pt": "Alterado {changed}   Concluído {succeeded}   Falhou {failed}   Incerto {uncertain}   Salvamentos {saved}",
        "zh-Hans": "已更改 {changed}   成功 {succeeded}   失败 {failed}   不确定 {uncertain}   保存 {saved}",
    },
    "changes.select_event": {"en": "Select an activity row to inspect its bounded details.", "de": "Wählen Sie eine Aktivität aus, um die begrenzten Details zu sehen.", "fr": "Sélectionnez une activité pour afficher ses détails limités.", "es": "Seleccione una actividad para ver sus detalles limitados.", "pt": "Selecione uma atividade para ver os detalhes limitados.", "zh-Hans": "选择一条活动以查看其限定详情。"},
    "changes.mutation": {"en": "MCP mutation", "de": "MCP-Änderung", "fr": "Modification MCP", "es": "Cambio MCP", "pt": "Alteração MCP", "zh-Hans": "MCP 更改"},
    "changes.document": {"en": "Document", "de": "Dokument", "fr": "Document", "es": "Documento", "pt": "Documento", "zh-Hans": "文稿"},
    "changes.target_detail": {"en": "Target: {target}", "de": "Ziel: {target}", "fr": "Cible : {target}", "es": "Destino: {target}", "pt": "Alvo: {target}", "zh-Hans": "目标：{target}"},
    "changes.warning_detail": {"en": "Warning: {warning}", "de": "Warnung: {warning}", "fr": "Avertissement : {warning}", "es": "Advertencia: {warning}", "pt": "Aviso: {warning}", "zh-Hans": "警告：{warning}"},
    "changes.opaque_detail": {"en": "This generic code operation is opaque; its document effects were not inspected.", "de": "Dieser allgemeine Code-Aufruf ist undurchsichtig; seine Dokumentwirkung wurde nicht untersucht.", "fr": "Cette opération de code générique est opaque ; ses effets sur le document n’ont pas été inspectés.", "es": "Esta operación de código genérica es opaca; no se inspeccionaron sus efectos en el documento.", "pt": "Esta operação de código genérica é opaca; seus efeitos no documento não foram inspecionados.", "zh-Hans": "此通用代码操作是不透明的，未检查它对文稿的影响。"},
    "changes.reset_confirm_title": {"en": "Reset MCP change history?", "de": "MCP-Änderungsverlauf zurücksetzen?", "fr": "Réinitialiser l’historique des modifications MCP ?", "es": "¿Restablecer el historial de cambios MCP?", "pt": "Redefinir o histórico de alterações MCP?", "zh-Hans": "重置 MCP 更改历史记录？"},
    "changes.reset_confirm_body": {"en": "This clears only the in-memory MCP ledger. It does not modify or save the font.", "de": "Nur das MCP-Protokoll im Arbeitsspeicher wird gelöscht. Die Schrift wird weder geändert noch gesichert.", "fr": "Seul le registre MCP en mémoire sera effacé. La police ne sera ni modifiée ni enregistrée.", "es": "Esto solo borra el registro MCP en memoria. No modifica ni guarda la fuente.", "pt": "Isso apaga apenas o registro MCP em memória. Não altera nem salva a fonte.", "zh-Hans": "这只会清除内存中的 MCP 记录，不会修改或保存字体。"},
    "changes.outcome.changed": {"en": "Changed", "de": "Geändert", "fr": "Modifié", "es": "Cambiado", "pt": "Alterado", "zh-Hans": "已更改"},
    "changes.outcome.no_change": {"en": "No change", "de": "Keine Änderung", "fr": "Aucun changement", "es": "Sin cambios", "pt": "Sem alteração", "zh-Hans": "无更改"},
    "changes.outcome.succeeded": {"en": "Succeeded", "de": "Erfolgreich", "fr": "Réussi", "es": "Correcto", "pt": "Concluído", "zh-Hans": "成功"},
    "changes.outcome.saved": {"en": "Saved", "de": "Gesichert", "fr": "Enregistré", "es": "Guardado", "pt": "Salvo", "zh-Hans": "已保存"},
    "changes.outcome.failed": {"en": "Failed", "de": "Fehlgeschlagen", "fr": "Échoué", "es": "Fallido", "pt": "Falhou", "zh-Hans": "失败"},
    "changes.outcome.uncertain": {"en": "Uncertain", "de": "Unklar", "fr": "Incertain", "es": "Incierto", "pt": "Incerto", "zh-Hans": "不确定"},
    # Common
    "app.title": {
        "en": "Glyphs MCP Server",
    ...
    "common.cancel": {"en": "Cancel", "de": "Abbrechen", "fr": "Annuler", "es": "Cancelar", "pt": "Cancelar", "zh-Hans": "取消"},
