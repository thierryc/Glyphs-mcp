...
- [Full-resolution three-family sheet](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/content/contributor/images/italic-balanced-three-family-story.png)
- [Broad-Latin benchmark and clean-room provenance](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/content/contributor/italic-balanced-broad-latin-benchmark.md)
- [Experimental italic guide](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/content/italic-first-pass.md)
- [`glyphs-mcp-italic-first-pass` skill](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/skills/glyphs-mcp-italic-first-pass/SKILL.md)
