...
:::note Version 1 documentation
This guide preserves the released **Glyphs MCP 1.11.0** workflow. The Milestone 6 installer retains this payload for Glyphs 3. For the lean Glyphs 4 candidate, use the [v2 guide](/docs/v2/).
:::
