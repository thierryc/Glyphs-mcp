...
- [`glyphs-mcp-icon-font` skill](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/skills/glyphs-mcp-icon-font/SKILL.md)
- [Unicode assignment tool notes](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/content/contributor/unicode-assignment-tools.md)
- [Glyphs MCP command set](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/content/reference/command-set.mdx)
...
- [`glyphs-mcp-icon-font`](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/skills/glyphs-mcp-icon-font/SKILL.md)
- [Unicode assignment notes](https://github.com/thierryc/Glyphs-mcp/blob/v1.11.0/content/contributor/unicode-assignment-tools.md)
