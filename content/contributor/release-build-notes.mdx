...
Version `1.2.24` is prepared on the `glyphs4` branch as the Glyphs 4 MCP server build. The shared server code keeps the Glyphs 3 install path available with `--glyphs-version 3` where possible.
