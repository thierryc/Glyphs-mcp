...
| `glyphs-mcp-italic-first-pass` | Guarded roman-to-italic first-pass copy and slant workflows | `Use the glyphs-mcp-italic-first-pass skill to review selected glyphs before applying an italic first pass.` |
