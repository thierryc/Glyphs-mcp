...
The beta branch prepares product 2.0.0 Beta 5, release `2.0.0-beta.5`, installer build 47. Sidecar and bridge product versions are `2.0.0`; lean interface revision and bridge protocol are `1`. Eleven managed skills accompany nine tools and up to nine capability-gated job kinds. See [version and identity](../content/reference/version-identity.mdx).
...
The Beta 5 payload is Glyphs 4-only. Glyphs 3 retains its separate v1.11.0
