...
For a manual global Cursor install, copy the 14 skill directories from
...
| `glyphs-mcp-scripting` | Staged document Python, reviewed open-world fallback, and verified rollback | `Use $glyphs-mcp-scripting because the typed tools do not fit this document edit.` |
...
| `glyphs-mcp-production-audit` | Read-first compatibility, metrics, anchor, spacing, kerning, and export review | `Use $glyphs-mcp-production-audit to review this source without changing it.` |
