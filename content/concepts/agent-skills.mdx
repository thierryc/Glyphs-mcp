...
manages the shared agent package: it copies the thirteen canonical directories from
...
package version instead of maintaining thirteen independent version fields, while
