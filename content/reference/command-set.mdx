...
| Tool | Description |
| --- | --- |
| `docs_search` | Search the official Glyphs ObjectWrapper, version 3/4 format specifications, and regular schemas; results include source kind, format version, and URL. |
