...
The current target is product **2.0.0**, release **2.0.0-beta.6**, beta number **6**,
installer build **48**: **eleven managed skills**, twelve MCP tools and up to ten
...
separately. Independent companions retain their own versions. The Beta 6
...
Use the helper's release tag and channel URLs. Beta 6 uses `v2.0.0-beta.6` and
`lit/v2-beta`, including
`https://raw.githubusercontent.com/thierryc/Glyphs-mcp/lit/v2-beta/appcast.xml`.
Beta DMG and ZIP names include `2.0.0-beta.6`. Do not publish a beta Latest alias;
