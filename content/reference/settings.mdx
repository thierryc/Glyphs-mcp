...
| `Kerning` | Kerning worklists, bumper review, and kerning apply steps. |
| `Spacing` | Spacing review/apply and spacing guides. |
| `Kerning + Spacing` | You need both kerning and spacing workflows. |
| `Paths / Outlines` | You are inspecting paths, selected nodes, outline smoothness, stems, or italic first-pass previews. |
| `Editing` | You need glyph, component, anchor, metrics, stem, or italic first-pass mutation tools. |
| `Full` | You deliberately want the complete server surface. |
