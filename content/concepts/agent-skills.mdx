...
manages the shared agent package: it copies the ten canonical directories from
...
package version instead of maintaining ten independent version fields, while
