...
GitHub Copilot supports MCP servers natively in VS Code 1.99+. The easiest setup:

1. Open Command Palette → **MCP: Add Server**
2. Select type `http`, enter URL `http://127.0.0.1:9680/mcp/`
3. Enter server ID: `glyphs`
4. Choose **Global** for user-wide config (or **Workspace** for project-only)

For manual setup, run **MCP: Open User Configuration** or add to `.vscode/mcp.json`.
