...
Use the helper's release tag and channel URLs. Beta 4 uses `v2.0.0-beta.4` and
`lit/v2-beta`, including
`https://raw.githubusercontent.com/thierryc/Glyphs-mcp/lit/v2-beta/appcast.xml`.
Beta DMG and ZIP names include `2.0.0-beta.4`. Do not publish a beta Latest alias;
