...
Code, Cursor, and GitHub Copilot CLI. All four manifests use version `1.11.1`
...
| `glyphs-mcp-release` | Version, docs, packaging, validation, signing, and publication gates | `Use $glyphs-mcp-release to prepare version 1.11.1 and stop before external publication.` |
...
- For live scripting mutations, review the exact `snippet_only` code and target,
  then approve only unchanged execution; revised code requires new approval.
