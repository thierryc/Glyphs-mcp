...
The current target is product **2.0.0**, release **2.0.0-beta.3**, beta number **3**,
installer build **45**: **eleven managed skills**, seven MCP tools and five job
...
separately. Independent companions retain their own versions. The Beta 3
...
Use the helper's release tag and channel URLs. Beta 3 uses `v2.0.0-beta.3` and
`lit/v2-beta`, including
`https://raw.githubusercontent.com/thierryc/Glyphs-mcp/lit/v2-beta/appcast.xml`.
Beta DMG and ZIP names include `2.0.0-beta.3`. Do not publish a beta Latest alias;
