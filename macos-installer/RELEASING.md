...
The current candidate is Glyphs MCP Desktop 2.0.0 Beta 6 / build 48,
...
The Glyphs 4-only payload has twelve tools, eleven managed skills, two optional
...
at v1.11.0 / 13ca805; it is not packaged in Beta 6.
...
scripts/verify_release_artifacts.sh --tag v2.0.0-beta.6 --write-checksums
```
