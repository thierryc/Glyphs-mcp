"""FastMCP transport for the standalone nine-tool sidecar."""
...
def create_server(service: SidecarService, *, control_token: str | None = None) -> Any:
    ...
    def start_job(
        ...
        """Prepare a supported mutation, feature_compile diagnostic, or font_export artifact through negotiated jobCapabilities. Closed jobs accept only typed fields and never accept Python, menu items, or selectors. get_job reports evidence."""
        return _result(
    ...
    def apply_job(job_id: str, include_preview: bool = True) -> dict[str, Any]:
        """Apply mutation jobs only as a reversible live change; diagnostic and artifact jobs are not applicable. This is not acceptance."""
