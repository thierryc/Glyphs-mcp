...
PREVIEW_CHANGE_DATA_SCHEMA = _closed(
    ...
    ),
    {
        ...
        "changedTargetCount": {"type": "integer", "minimum": 0},
        "skippedTargetCount": {"type": "integer", "minimum": 0},
...
TOOL_DEFINITIONS: Tuple[ToolDefinition, ...] = (
    ...
    _definition(
        "preview_change",
        "Preview Change",
        "Resolve exact targets and mechanically simulate generic operations with floating-point geometry into one immutable preview.",
        "change",
    ...
    _definition(
        "apply_change",
        "Apply Change",
        "Apply one exact immutable preview through the floating-geometry verified transaction kernel without rerunning planning.",
        "change",
        "edit",
