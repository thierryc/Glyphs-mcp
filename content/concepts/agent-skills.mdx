...
The installed ChatGPT/Codex plugin carries its own synchronized `skills/`
directory. `scripts/sync_codex_plugin_skills.sh` copies the eight canonical
directories from `skills/` into `plugins/glyphs-mcp/skills/`; do not edit the
packaged copies independently.
