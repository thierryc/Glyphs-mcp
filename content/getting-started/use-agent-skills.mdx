...
Code, Cursor, and GitHub Copilot CLI. All four manifests use version `1.10.0`
...
For a manual global Cursor install, copy the 10 skill directories from
...
| `glyphs-mcp-release` | Version, docs, packaging, validation, signing, and publication gates | `Use $glyphs-mcp-release to prepare version 1.10.0 and stop before external publication.` |
