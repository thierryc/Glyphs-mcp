...
The current candidate is Glyphs MCP Desktop 2.0.0 Beta 5 / build 47,
...
at v1.11.0 / 13ca805; it is not packaged in Beta 5.
...
scripts/verify_release_artifacts.sh --tag v2.0.0-beta.5 --write-checksums
```
