...
Code, Cursor, and GitHub Copilot CLI. All four manifests use version `1.8.0`
...
| `glyphs-mcp-release` | Version, docs, packaging, validation, signing, and publication gates | `Use $glyphs-mcp-release to prepare version 1.8.0 and stop before external publication.` |
