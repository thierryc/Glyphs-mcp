...
registered native omission defaults, identity-addressed storage order, derived
grid/alignment effects, and bounded component-decomposition round trips may be
treated as equivalent. Use `strict_archive` when diagnosing native archive
